...
<div class="input-group flex items-center mb-4">
  ...
  <style>
	...
	<div class="form-row place-order">
		<noscript>
			<?php esc_html_e( 'Since your browser does not support JavaScript, or it is disabled, please ensure you click the <em>Update Totals</em> button before placing your order. You may be charged more than the amount stated above if you fail to do so.', 'maison' ); ?>
			<br/><input type="submit" class="button alt" name="woocommerce_checkout_update_totals" value="<?php esc_attr_e( 'Update totals', 'maison' ); ?>" />
		</noscript>
		...
		<?php echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" onclick="submitForm()" class="btn btn-primary btn-block alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' ); ?>
